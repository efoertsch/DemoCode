...
public class Auth {
     ...
     */
    public static Credential authorize(Context context, List<String> scopes, String credentialDatastore) throws IOException {
        ...
        //|| clientSecrets.getDetails().getClientSecret().startsWith("Enter "  getClientSecret returns null
